    ...
    if amount == 0:                                                     # FREE FLOW
        ...
        if current_weight <= end_weight or digit == "#":
            ...
            if digit == "#":
                ...
                transactions_end2 = open('transactions_1.txt', 'a')
                transactions_end2.write("END " + time.strftime("%Y%m%d-%H%M") + "\n")
                transactions_end2.close()
